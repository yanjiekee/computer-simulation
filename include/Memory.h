...
#define MEMORY_STATIC_LOWERLIMIT    0x00000800
#define MEMORY_STATIC_UPPERLIMIT    0x000008ff
#define MEMORY_HEAP_LOWERLIMIT      0x00000900
#define MEMORY_STACK_UPPERLIMIT     0x00000aff
